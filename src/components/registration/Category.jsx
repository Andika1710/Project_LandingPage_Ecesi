...
const Category = () => {
  ...
  return (
    <>
    <div className='container mx-auto px-[25px] lg:mb-[56px]'>
        <div className='category shadow-lg px-[20px] pt-[20px] border rounded-[24px] border-border pb-[36px] mt-[36px] lg:px-[48px] lg:py-[45px]'>
            <p className='text-[18px] leading-[24px] font-bold lg:text-left font-jakarta text-globalGreen text-center pb-[24px] lg:text-[24px] lg:leading-[24px] py-[10px] lg:py-[30px]'>Category</p>
