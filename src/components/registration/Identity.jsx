            ...
            <div className='identity  shadow-lg px-[20px] pt-[20px] border rounded-[24px] border-border pb-[36px] mt-[36px] lg:px-[48px]'>
                ...
                <div className='gap-[20px] lg:gap-[40px] flex flex-col'>
                    <form action="" className='flex items-center border px-3 lg:px-[48px] py-2 rounded-[35px] border-input'>
                        ...
                        />
                        <img className='w-[14.5px] lg:w-[20px]' src={person} alt="icon Person" />
                    </form>
                    <form action="" className='flex items-center border px-3 lg:px-[48px] py-2 rounded-[35px] border-input'>
                        <input type="text"
                        placeholder='Email'
                        className='w-full bg-transparent p-2 text-[12px] leading-[15.83px] lg:text-[18px] lg:leading-[24px] font-medium font-jakarta text-globalGreen outline-none'
                        />
                        <img className='w-[14.5px] lg:w-[20px]' src={email} alt="icon Email" />
                    </form>
                    <form action="" className='flex items-center border px-3 lg:px-[48px] py-2 rounded-[35px] border-input'>
                        <input type="text"
                        placeholder='Phone'
                        className='w-full bg-transparent p-2 text-[12px] leading-[15.83px] lg:text-[18px] lg:leading-[24px] font-medium font-jakarta text-globalGreen outline-none'
                        />
                        <img className='w-[14.5px] lg:w-[20px]' src={phone} alt="icon Telpon" />
                    </form>
                    <form action="" className='flex items-center border px-3 lg:px-[48px] py-2 rounded-[35px] border-input'>
                        <input type="text"
                        placeholder='Country'
                        className='w-full bg-transparent p-2 text-[12px] leading-[15.83px] lg:text-[18px] lg:leading-[24px] font-medium font-jakarta text-globalGreen outline-none'
                        />
                        <img className='w-[14.5px] lg:w-[20px]' src={globe} alt="icon Globe" />
                    </form>
                    ...
                    <form action="" className='flex items-center border px-3 lg:px-[48px] py-2 rounded-[35px] border-input'>
                        ...
                        className='w-full bg-transparent p-2 text-[12px] leading-[15.83px] lg:text-[18px] lg:leading-[24px] font-medium font-jakarta text-globalGreen outline-none'
                        />
                        <img className='w-[14.5px] lg:w-[20px]' src={gedung} alt="icon Gedung" />
                    </form>
                </div>
            </div>
        </div>
